...
def _init_providers() -> None:
    global PROVIDERS, PROVIDER_CATEGORIES
    from sediman.llm.provider_loader import load_providers, load_provider_categories

    PROVIDERS.update(load_providers())
    PROVIDER_CATEGORIES.update(load_provider_categories())
...
def list_providers() -> list[dict[str, Any]]:
    ...
    for name, preset in PROVIDERS.items():
        ...
        result.append({
            ...
            "auto_detect": preset.get("auto_detect", False),
        })
    return result
